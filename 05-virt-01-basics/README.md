...
- Высоконагруженная база данных, чувствительная к отказу.  
    ...
    Так-как у базы данных для хранения бедет использоваться система хранения данных это физический сервер, а программная чать на сервере с виртуализацией.  

- Различные web-приложения.
    - виртуализация уровня ОС

    Веб приложения, к примеру на `LAMP` не прохо себя чувствую на рода контейнераз типа Docker.
